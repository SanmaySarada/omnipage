              ...
              <div className="text-slate-300 space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <ol className="list-decimal list-inside space-y-3 text-base text-slate-300 font-light font-sans ml-4">
                  ...
                  <p 
                    ...
                    className={`text-base text-slate-300 font-light font-sans italic mt-8 pt-8 border-t border-white/10 ${isLoaded ? 'animate-fade-in' : ''}`}
                  >
